    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) => di.sl<LanguageController>(),
        ),
        ChangeNotifierProvider(
        ...
        ChangeNotifierProvider(
          create: (context) => di.sl<BankInfoController>(),
        ),
        ChangeNotifierProvider(create: (context) => di.sl<ChatController>()),
        ChangeNotifierProvider(
          create: (context) => di.sl<BusinessController>(),
        ),
        ChangeNotifierProvider(
        ...
        ChangeNotifierProvider(
          create: (context) => di.sl<ClearanceSaleController>(),
        ),
        ChangeNotifierProvider(
          create: (context) => di.sl<CustomerController>(),
        ),
        ChangeNotifierProvider(
          create: (context) => di.sl<CouponDiscountController>(),
        ),
        ChangeNotifierProvider(
          create: (context) => di.sl<BarcodeScanController>(),
        ),
        ChangeNotifierProvider(
          create: (context) => di.sl<AddProductImageController>(),
        ),
        ChangeNotifierProvider(
          create: (context) => di.sl<VariationController>(),
        ),
        ChangeNotifierProvider(
          create: (context) => di.sl<DigitalProductController>(),
        ),
        ChangeNotifierProvider(
              ...
              child: Stack(
                children: [
                  ...
                  if (productController.stockLimitStatus != null &&
                      ...
                      (productController.stockLimitStatus?.productCount ?? 0) <
                          0)
